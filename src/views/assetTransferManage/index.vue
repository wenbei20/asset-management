  ...
  <div class="app-container">
    ...
    <el-row style="padding-top:20px;">
      ...
      >
        ...
        <vxe-table-column field="eventID" title="调拨单号" />
        <vxe-table-column field="status" title="调出单位" />

        <vxe-table-column field="date" title="调入单位" />
        <vxe-table-column field="person" title="调入管理员" />
        <vxe-table-column field="title" title="备注" />
    ...
    <addDialog :visible.sync="showAddDialog" />
  </div>
</template>
